  ...
  if(!started){
   ...
   for(int i = 0; i < game.getPlayer(0).getDeck().size(); i++){
     if(!(game.getPlayer(0).getDeck().getCard(i).isSelected())){
       fill(250);
       image(game.getPlayer(0).getDeck().getCard(i).getImage(), width/3 - 50 + (i*40), height - 150, 100, 140*(337/240));
   //    image(images.get(i), width/3 - 50 + (i*40), height - 150, 100, 140*(337/240));
     }
     else{
       fill(250);
       image(game.getPlayer(0).getDeck().getCard(i).getImage(), width/3 - 50 + (i*40), height - 210, 100, 140*(337/240));
